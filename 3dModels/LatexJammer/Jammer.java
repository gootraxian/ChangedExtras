...
public class Jammer<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "jammer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Snout_r2 = Head.addOrReplaceChild("Snout_r2", CubeListBuilder.create().texOffs(8, 92).addBox(-0.5F, -30.0F, -6.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 21.0F, -9.0F, 0.0F, -2.3126F, 0.0F));

		PartDefinition Snout_r3 = Head.addOrReplaceChild("Snout_r3", CubeListBuilder.create().texOffs(0, 92).addBox(-0.5F, -30.0F, -6.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 26.0F, -7.0F, 0.0F, 2.5744F, 0.0F));

		PartDefinition Snout_r4 = Head.addOrReplaceChild("Snout_r4", CubeListBuilder.create().texOffs(0, 92).addBox(-1.0F, -30.0F, -6.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 26.0F, 3.0F, 0.0F, 0.5672F, 0.0F));
		...
		PartDefinition Torso_r1 = Torso.addOrReplaceChild("Torso_r1", CubeListBuilder.create().texOffs(21, 85).addBox(-3.0F, -26.0F, -3.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 26.0F, 0.0F, 0.0F, 0.48F, 0.0F));

		PartDefinition Torso_r2 = Torso.addOrReplaceChild("Torso_r2", CubeListBuilder.create().texOffs(10, 84).addBox(-3.0F, -26.0F, -3.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 26.0F, 1.0F, 0.0F, -0.48F, 0.0F));
